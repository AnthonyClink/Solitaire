...
public class Card {
	...
	public static final Card ACE_OF_SPADES = new Card(Rank.ACE, Suit.SPADES, CardState.FACE_UP);
	public static final Card ACE_OF_HEARTS = new Card(Rank.ACE, Suit.HEARTS, CardState.FACE_UP);
